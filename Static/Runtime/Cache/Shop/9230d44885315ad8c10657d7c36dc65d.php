...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<a href="<?php echo U('MessageCheck/issuedMessage');?>" class="mail"><?php echo (L("_WAP_MESSAGE_MYPOSTHISTORY_")); ?></a>
		</header>
		<div class="main">
				...
				<ul>
					<li v-for="(item, index) in messageList">
						<div class="sysbox" @click="jumpToMessage(item['id'])">
							...
							<a href="javascript:;" class="seenews"><?php echo (L("_COMMON_SEE_DETAILS_")); ?>></a>
						</div>
					</li>
				</ul>
				<a href="<?php echo U('MessageCheck/issuingMessage');?>" class="releaseNews"><?php echo (L("_WAP_MESSAGE_CREATEPOST_")); ?></a>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	var vm = new Vue({
		...
		methods : {
			...
			jumpToMessage(id) {
				window.location.href = "<?php echo U('Message/messageDetail');?>?id=" + id;
			}
		}
	})
</script>
