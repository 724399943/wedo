...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<h1 class="y-confirm-order-h1"><?php echo (L("_WAP_AGENT_SETTING_")); ?></h1>
		</header>
		<div class="main">
			<div class="y-bindphone">
				<ul>
					<li @click="showSelLang">
						<a href="javascript:;">
							<span><?php echo (L("_WAP_SETTING_CHANGE_LANGUAGE_")); ?></span>
							<i></i>
						</a>
					</li>
					<li>
						<a href="<?php echo U('Article/articleDetail', array('sign'=> 'aboutUs'));?>">
							<span><?php echo (L("_PC_SETTING_ABOUT_US_")); ?></span>
							<i></i>
						</a>
					</li>
					<li class="editpsw">
						<a href="<?php echo U('Article/articleDetail', array('sign'=> 'agreement'));?>">
							<span><?php echo (L("_PC_SETTING_USER_AGREEMENT_")); ?></span>
							<i></i>
						</a>
					</li>
					<li>
						<a href="<?php echo U('User/userFeedback');?>">
							<span><?php echo (L("_WAP_SETTING_FEEDBACK_")); ?></span>
							<i></i>
						</a>
					</li>
				</ul>
			</div>
			<a href="<?php echo U('Login/logout');?>" class="widup"><?php echo (L("_PC_TOP_MENU_LOGOUT_")); ?></a>
	...
	<script type="text/javascript">
		var vm = new Vue({
			...
			methods : {
				...
				changeFun(){
					$.ajax({
						url : '<?php echo U('User/chooseLanguage');?>',
						type : 'POST',
						dataType : 'json',
