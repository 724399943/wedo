...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<h1 class="y-confirm-order-h1"><?php echo (L("_WAP_POINT_POINTSSTATEMENT_")); ?></h1>
		</header>
		<div class="main">
				...
				<div class="set_d_list">
					<ul>
						<li v-for="(item,index) in pointLog">
							...
							<a :href="'<?php echo U('Point/orderDetail');?>?order_sn='+item.order_sn" v-if="item.event_type == 7"><?php echo (L("_WAP_POINTORDER_REDEEMDETAILS_")); ?></a>
						</li>
					</ul>
				</div>
			</div>
