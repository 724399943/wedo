...
<body>
	...
	<div class="content" id="content">
		<div class="ident_nav">
			<em class="back"></em>
			<span class="on" @click="ontab(0)"><?php echo (L("_WAP_POINTORDER_NOTBUMPTOTOP_")); ?></span>
			<span @click="ontab(1)"><?php echo (L("_WAP_POINTORDER_HASBEENBUMPTOTOP_")); ?></span>
		</div>
		<div class="ident_search">
			<em></em>
			<input type="text" name="" placeholder="<?php echo (L("_COMMON_SEARCH_FOR_PRODUCTS_")); ?>" v-model="keyword" @change="searchGoods">
		</div>
		<div class="integral_goods" v-if="nothing == 0">
			...
			<div class="is_hgoods" v-if="is_recommend == 0">
				<div class="sel_goodsm">
					...
					<div class="allBox">
						<div class="selectAll">
							...
							<span style=""><?php echo (L("_COMMON_ALL_SELECTED_")); ?></span>
						</div>
					</div>
					<br style="clear: both" />
				...
				<a href="javascript:;" class="widup" @click="goodsToTop"><?php echo (L("_WAP_POINTORDER_BUMPTOTOP_")); ?></a>
			</div>
			<!-- 已认证 -->
		...
		<div class="no_igoods" v-else-if="nothing == 1 && is_recommend == 0">
			<p><?php echo (L("_WAP_POINTORDER_NOTHAVEUNBUMPTOTOP_")); ?></p>
		</div>
		<div class="no_igoods" v-else-if="nothing == 1 && is_recommend == 1">
			<p><?php echo (L("_WAP_POINTORDER_NOTHAVEBUMPTOTOP_")); ?></p>
		</div>
	</div>
	...
	var vm = new Vue({
		...
		methods : {
			...
			goodsToTop : function(){
				...
				$.ajax({
					url : "<?php echo U("GoodsCheck/goodsToTop");?>",
					type : "POST",
					dataType : "json",
					data : {
