...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<h1 class="y-confirm-order-h1"><?php echo (L("_WAP_BIDDING_BIDDINGINDEXGOODS_")); ?></h1>
		...
		<div class="main">
			...
			<div class="integral_goods">
				<div class="is_hgoods" v-if="nothing == 0">
					...
					<a :href="'/Bidding/toBiddingIndexGoods?goods_id='+goods_id" class="widup"><?php echo (L("_WAP_BIDDING_APPLYFORBIDDING_")); ?></a>
				</div>
