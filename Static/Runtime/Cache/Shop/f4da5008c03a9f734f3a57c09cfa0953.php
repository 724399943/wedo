			...
			<ul>
				<li>
					<a href="<?php echo U('Agent/agentGoodsCategory');?>">
						<span><?php echo (L("_WAP_AGENT_CATEGORIESMANAGEMENT_")); ?></span>
						<em></em>
					</a>
				</li>
				<li>
					<a href="<?php echo U('Agent/agentGoods');?>">
						<span><?php echo (L("_WAP_AGENT_EXISTINGPRODUCTS_")); ?></span>
						<em></em>
					</a>
				</li>
				<li>
					<a href="<?php echo U('Goods/addGoods');?>">
						<span><?php echo (L("_WAP_AGENT_ADDAPRODUCT_")); ?></span>
						<em></em>
					</a>
				</li>
				<li>
					<a href="<?php echo U('Agent/agentGoodsComment');?>">
						<span><?php echo (L("_WAP_AGENT_REVIEWMANAGEMENT_")); ?></span>
						<em></em>
					</a>
				</li>
			</ul>
