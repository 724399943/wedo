...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<h1 class="y-confirm-order-h1"><?php echo (L("_WAP_POINTORDER_REDEEMHISTORY_")); ?></h1>
		</header>
		<div class="main">
	...
	var vm = new Vue({
		...
		methods : {
			loadGoods : function() {
				var that = this;
				$.ajax({
					url: '<?php echo U('PointOrder/pointOrder');?>',
					type: 'POST',
					dataType: 'json',
					data: {
						page : that.page,
			...
			jumpToDetail(id) {
				window.location.href = "<?php echo U('PointOrder/pointOrderDetail');?>?order_sn=" + id;
			}
		}
	})
</script>
