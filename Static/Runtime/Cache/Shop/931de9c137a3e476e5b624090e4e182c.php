...
<div class="pageheader">
    <h1 class="pagetitle">
    	<?php echo (L("_PC_SETTING_CHOOSE_LANGUAGE_")); ?>
    </h1>
    <span class="pagedesc"></span>
</div>

<div id="contentwrapper" class="contentwrapper">
	<form class="stdform stdform2" action="<?php echo U('User/chooseLanguage');?>" method="POST">
		<div class="line-dete">
			<label><?php echo (L("_PC_SETTING_CHOOSE_LANGUAGE_")); ?></label>
	        <span class="field">
	        	<input type="radio" name="language" value="zh-cn" <?php if($_COOKIE['think_language'] == 'zh-cn'): ?>checked<?php endif; ?>><?php echo (L("_PC_SETTING_CHINESE_")); ?>
	        	<input type="radio" name="language" value="en-us" <?php if($_COOKIE['think_language'] == 'en-us'): ?>checked<?php endif; ?>><?php echo (L("_PC_SETTING_ENGLISH_")); ?>
	        	<br>
	        	<i style="color: #967bdc;font-weight: bold;"><?php echo (L("_PC_SETTING_LANGUAGE_TIPS_")); ?></i>
	        </span>
		</div>
		<div class="line-dete">
			<label></label>
	        <span class="field">
	        	<input type="submit" class="stdbtn" value="<?php echo (L("_PC_SETTING_SWITCH_")); ?>" />
	        </span>
		</div>
	</form>
</div>
