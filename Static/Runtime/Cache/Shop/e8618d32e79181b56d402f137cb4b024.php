...
<body>
	...
	<div class="content" id="content">
		<header class="head">
			...
			<h1 class="y-confirm-order-h1"><?php echo (L("_WAP_BIDDING_PROMOTIONALPRODUCTSBIDDING_")); ?></h1>
			<a :href="'/Bidding/biddingRecord?bidding_type='+bidding_type+ '&&' +'tab='+tab" class="mail"><?php echo (L("_WAP_BIDDING_BIDDINGRECORD_")); ?></a>
		</header>
		<div class="main">
			...
			<div class="integral_goods">
				<div class="is_hgoods" v-if="nothing">
					...
					<a :href="'/Bidding/toBiddingFavorableGoods?goods_id='+goods_id" class="widup"><?php echo (L("_WAP_BIDDING_APPLYFORBIDDING_")); ?></a>
				</div>
