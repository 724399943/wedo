...
function addLink(domid){
	art.dialog.data('domid', domid);
	console.log("{:U('Weixin/selectKeywordType')}");return;
	art.dialog.open("{:U('Weixin/selectKeywordType')}",{lock:true,title:'插入关键词',width:600,height:400,yesText:'关闭',background: '#000',opacity: 0.45});
}
