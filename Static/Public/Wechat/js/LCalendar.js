        ...
        bindEvent: function(type) {
            ...
            function popupDate(e) {
                ...
                _self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
                    ...
                    '</div>' +
                    '</div>';
                document.getElementById('content').appendChild(_self.gearDate);
                dateCtrlInit();
            ...
            function closeMobileCalendar(e) {
                ...
                document.getElementById('content').removeChild(_self.gearDate);
                _self.gearDate=null;
            }
            ...
            function finishMobileTime(e) {
                ...
                console.log((time_hh.length < 2 ? "0" : "") + time_hh + (time_mm.length < 2 ? ":0" : ":") + time_mm);
                _self.callback ? _self.callback() : '';
                closeMobileCalendar(e);
            }
