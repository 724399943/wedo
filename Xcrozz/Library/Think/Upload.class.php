...
class Upload {
     ...
     * @author kofu <418382595@qq.com>
     */
    private $createNewFileName = true;
     ...
     */
    public function __construct($config = array(), $driver = '', $driverConfig = null, $customUpload = false, $createNewFileName = true){
        /* 获取配置 */
    ...
    public function upload($files='') {
        ...
        foreach ($files as $key => $file) {
            ...
            /* 检测并创建子目录 */
            // modify
            $subpath = $this->customUpload === true ? '' : $this->getSubPath($file['name']);
            if(false === $subpath){
                continue;
            } else {
    ...
    private function getSaveName($file) {
        $rule = $this->saveName;
        // add by kofu 418382595@qq.com
        if ($this->createNewFileName === false) $rule = '';
